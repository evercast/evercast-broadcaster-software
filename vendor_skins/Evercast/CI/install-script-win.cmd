rem ---------------------------------------------------------------------
rem if exist Qt_5.14.2.7z (curl -kLO https://cdn-fastly.obsproject.com/downloads/Qt_5.14.2.7z -f --retry 5 -z Qt_5.14.2.7z) else (curl -kLO https://cdn-fastly.obsproject.com/downloads/Qt_5.10.1.7z -f --retry 5 -C -)
7z x Qt_5.14.2.7z -oQt
set QTDIR64=%CD%\Qt\5.14.2\msvc2017_64
rem ---------------------------------------------------------------------
...
rem ---------------------------------------------------------------------
rem if exist libWebRTC-73-win.tar.gz (curl -kLO https://libwebrtc-community-builds.s3.amazonaws.com/libWebRTC-73-win.tar.gz -f --retry 5 -z libWebRTC-73-win.tar.gz) else (curl -kLO https://libwebrtc-community-builds.s3.amazonaws.com/libWebRTC-73-win.tar.gz -f --retry 5 -C -)
rem tar -xzf libWebRTC-73-win.tar.gz
