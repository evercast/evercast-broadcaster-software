#ifndef __VIDEO_ROOM_WEBSOCKET_CLIENT_IMPL_H__
#define __VIDEO_ROOM_WEBSOCKET_CLIENT_IMPL_H__
...
class VideoRoomWebsocketClientImpl : public WebsocketClient {
public:
    VideoRoomWebsocketClientImpl();
    ~VideoRoomWebsocketClientImpl();
...
protected:
    ...
    virtual bool processJoinResponse(nlohmann::json &msg);
