	  ...
	  ui(new Ui_OBSUpdate)
{
	...
	char *instructionsName;
#ifdef WIN32
	instructionsName = "Updater.InstallInstructionsWin";
#else
	instructionsName = "Updater.InstallInstructionsMac";
#endif
	ui->installInstructionsLabel->setText(QTStr(instructionsName));
